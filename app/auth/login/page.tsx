                      ...
                      onClick={async () => {
                        try {
                          ...
                          if (!process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID) {
                            showError('Google OAuth Tidak Dikonfigurasi', 'Silakan hubungi administrator untuk mengaktifkan login Google', 5000)
                            return
                          }
                          ...
                          if (error) {
                            ...
                            showError('Google Login Gagal', 'Pastikan Google OAuth sudah dikonfigurasi dengan benar di Supabase', 5000)
                          }
                        } catch (error) {
                          console.error('Google OAuth error:', error)

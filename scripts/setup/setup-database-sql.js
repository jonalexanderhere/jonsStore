...
async function setupDatabaseWithSQL() {
  try {
    console.log('🚀 Setting up database with SQL...')
...
('8', 'Mainan & Hobi', 'Mainan anak-anak dan perlengkapan hobi untuk semua usia', 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop', true);
    ...
    const { error: categoriesError } = await supabase.rpc('exec_sql', { sql: insertCategoriesSQL })
...
('4', 'Samsung Galaxy S24 Ultra', 'Smartphone Android premium dengan kamera 200MP dan S Pen', 18999000, 21999000, ARRAY['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=500&h=500&fit=crop'], '1', 40, true, true, ARRAY['smartphone', 'samsung', 'android', 'premium']),
('5', 'Dell XPS 13', 'Laptop ultrabook dengan layar InfinityEdge dan performa tinggi', 17999000, 19999000, ARRAY['https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1587831990711-23ca6441447b?w=500&h=500&fit=crop'], '1', 25, true, false, ARRAY['laptop', 'dell', 'ultrabook', 'business']),
('6', 'AirPods Pro 2', 'Earbuds wireless dengan noise cancellation dan spatial audio', 2999000, 3499000, ARRAY['https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=500&h=500&fit=crop'], '1', 80, true, false, ARRAY['earbuds', 'apple', 'wireless', 'noise-cancellation']),
('7', 'iPad Pro 12.9"', 'Tablet profesional dengan chip M2 dan layar Liquid Retina XDR', 12999000, 14999000, ARRAY['https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1561154464-82ee9adf2394?w=500&h=500&fit=crop'], '1', 35, true, true, ARRAY['tablet', 'apple', 'ipad', 'pro']),
('8', 'Samsung 55" QLED TV', 'Smart TV 4K dengan teknologi QLED dan HDR10+', 8999000, 10999000, ARRAY['https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=500&h=500&fit=crop'], '1', 20, true, false, ARRAY['tv', 'samsung', '4k', 'smart']),
('9', 'Canon EOS R5', 'Kamera mirrorless profesional dengan sensor 45MP dan video 8K', 45999000, 49999000, ARRAY['https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1606983340126-99ab4feaa64a?w=500&h=500&fit=crop'], '1', 15, true, true, ARRAY['kamera', 'canon', 'mirrorless', 'profesional']),
('10', 'PlayStation 5', 'Konsol game generasi terbaru dengan grafis 4K dan ray tracing', 7999000, 8999000, ARRAY['https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1606144042614-b2417e99c4e4?w=500&h=500&fit=crop'], '1', 25, true, false, ARRAY['gaming', 'playstation', 'console', '4k']),

-- Fashion
('11', 'Levi''s 501 Original Jeans', 'Jeans klasik dengan potongan straight fit yang timeless', 899000, 1199000, ARRAY['https://images.unsplash.com/photo-1542272604-787c385553b7?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=500&h=500&fit=crop'], '2', 100, true, false, ARRAY['jeans', 'levis', 'denim', 'classic']),
('12', 'Zara Blazer Premium', 'Blazer formal dengan potongan slim fit dan bahan berkualitas tinggi', 1299000, 1599000, ARRAY['https://images.unsplash.com/photo-1594938298605-cd64d1906916?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&h=500&fit=crop'], '2', 50, true, true, ARRAY['blazer', 'zara', 'formal', 'business']),
('13', 'Nike Air Jordan 1', 'Sepatu basket legendaris dengan desain klasik dan kualitas premium', 2299000, 2799000, ARRAY['https://images.unsplash.com/photo-1549298916-b41d501d3772?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=500&h=500&fit=crop'], '2', 40, true, true, ARRAY['sneakers', 'nike', 'jordan', 'basketball']),

-- Olahraga
('14', 'Nike Air Max 270', 'Sepatu olahraga dengan teknologi terbaru dan desain yang stylish', 1999000, 2499000, ARRAY['https://images.unsplash.com/photo-1549298916-b41d501d3772?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=500&h=500&fit=crop'], '4', 75, true, false, ARRAY['sepatu', 'nike', 'olahraga', 'running']),
('15', 'Adidas Ultraboost 22', 'Sepatu lari dengan teknologi Boost untuk kenyamanan maksimal', 2299000, 2799000, ARRAY['https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500&h=500&fit=crop'], '4', 60, true, false, ARRAY['sepatu', 'adidas', 'running', 'boost']),
('16', 'Peloton Bike+', 'Sepeda statis premium dengan layar 22" dan kelas virtual interaktif', 24999000, 27999000, ARRAY['https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500&h=500&fit=crop'], '4', 10, true, true, ARRAY['fitness', 'bike', 'peloton', 'cardio']),
('17', 'Lululemon Yoga Mat', 'Mat yoga premium dengan teknologi anti-slip dan bahan ramah lingkungan', 899000, 1099000, ARRAY['https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500&h=500&fit=crop'], '4', 80, true, false, ARRAY['yoga', 'mat', 'lululemon', 'fitness']),
...
('21', 'Atomic Habits - James Clear', 'Buku bestseller tentang membangun kebiasaan baik dan menghilangkan kebiasaan buruk', 199000, 249000, ARRAY['https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=500&h=500&fit=crop', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&h=500&fit=crop'], '6', 150, true, false, ARRAY['buku', 'self-help', 'habits', 'motivation']);
    ...
    const { error: productsError } = await supabase.rpc('exec_sql', { sql: insertProductsSQL })
...
('${authData.user.id}', 'admin@ecommerce.com', 'Administrator', 'admin');
      `

      const { error: adminError } = await supabase.rpc('exec_sql', { sql: insertAdminSQL })
      
      if (adminError) {
        console.error('❌ Error creating admin user record:', adminError.message)
      } else {
    ...
    const { data: categoriesData, error: categoriesVerifyError } = await supabase
      .from('categories')
      .select('id, name')
      .eq('is_active', true)

    const { data: productsData, error: productsVerifyError } = await supabase
      .from('products')
      .select('id, name, is_featured')
      .eq('is_active', true)

    if (categoriesVerifyError) {
      console.error('❌ Error verifying categories:', categoriesVerifyError.message)
    } else {
      console.log(`✅ Found ${categoriesData.length} active categories`)
    }

    if (productsVerifyError) {
      console.error('❌ Error verifying products:', productsVerifyError.message)
    } else {
